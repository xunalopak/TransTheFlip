...
| Problème | Solution |
|----------|----------|
| **Connecté mais aucun texte reçu / pas de bouton OK** | **Flipper non appairé.** Appaire-le dans Paramètres Windows > Bluetooth et confirme le code sur l'écran du Flipper, puis relance le client. |
